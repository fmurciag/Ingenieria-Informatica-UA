...
public class BlockWorld_P4TestPlayFile {
	...
	public void testPlayFileDangerousPlanet1() {
		...
		PrintStream ps = standardIO2File("test/files/DangerousPlanet1.student");
		try {
			game.playFile("test/files/DangerousPlanet1.input");
		...
		StringBuilder sbAlu = readFromFile("test/files/DangerousPlanet1.student");
		StringBuilder sbSol = readFromFile("test/files/DangerousPlanet1.solution");
		compareLines(sbSol.toString(),sbAlu.toString());
	}
	
	@Test
	public void testPlayFileDangerousPlanet2() {
		BlockWorld game = BlockWorld.getInstance();
		PrintStream ps = standardIO2File("test/files/DangerousPlanet2.student");
		try {
			game.playFile("test/files/DangerousPlanet2.input");
		...
		StringBuilder sbAlu = readFromFile("test/files/DangerousPlanet2.student");
		StringBuilder sbSol = readFromFile("test/files/DangerousPlanet2.solution");
		compareLines(sbSol.toString(), sbAlu.toString());
