...
package body ada_main is
   ...
   E445 : Short_Integer; pragma Import (Ada, E445, "system__task_info_E");
   E439 : Short_Integer; pragma Import (Ada, E439, "system__task_primitives__operations_E");
   ...
   E476 : Short_Integer; pragma Import (Ada, E476, "system__random_seed_E");
   E460 : Short_Integer; pragma Import (Ada, E460, "system__tasking__initialization_E");
   E428 : Short_Integer; pragma Import (Ada, E428, "system__tasking__protected_objects_E");
   E456 : Short_Integer; pragma Import (Ada, E456, "system__tasking__protected_objects__entries_E");
   E468 : Short_Integer; pragma Import (Ada, E468, "system__tasking__queuing_E");
   E479 : Short_Integer; pragma Import (Ada, E479, "system__tasking__stages_E");
   ...
   E483 : Short_Integer; pragma Import (Ada, E483, "pkg_cronometro_realtime_E");
   E426 : Short_Integer; pragma Import (Ada, E426, "pkg_semaforo_E");
   E106 : Short_Integer; pragma Import (Ada, E106, "pkg_coches_E");
   E489 : Short_Integer; pragma Import (Ada, E489, "pkg_taxi_E");
   E487 : Short_Integer; pragma Import (Ada, E487, "pkg_peaton_E");
   E491 : Short_Integer; pragma Import (Ada, E491, "pkg_tren_E");
   ...
   begin
      ...
      declare
         procedure F4;
         pragma Import (Ada, F4, "double_buffer__finalize_body");
      begin
         E161 := E161 - 1;
         F4;
      end;
      declare
         procedure F5;
         pragma Import (Ada, F5, "double_buffer__finalize_spec");
      begin
         F5;
      end;
      E386 := E386 - 1;
      declare
         procedure F6;
         pragma Import (Ada, F6, "gtkada__style__finalize_spec");
      begin
         F6;
      end;
      E384 := E384 - 1;
      ...
      declare
         procedure F8;
         pragma Import (Ada, F8, "gtk__icon_theme__finalize_spec");
      begin
         F8;
      end;
      E420 := E420 - 1;
      ...
      declare
         procedure F10;
         pragma Import (Ada, F10, "gtk__drawing_area__finalize_spec");
      begin
         F10;
      end;
      E396 := E396 - 1;
      declare
         procedure F11;
         pragma Import (Ada, F11, "gtk__css_provider__finalize_spec");
      begin
         F11;
      end;
      E412 := E412 - 1;
      declare
         procedure F12;
         pragma Import (Ada, F12, "gtk__button__finalize_spec");
      begin
         F12;
      end;
      E410 := E410 - 1;
      declare
         procedure F13;
         pragma Import (Ada, F13, "gtk__alignment__finalize_spec");
      begin
         F13;
      end;
      E414 := E414 - 1;
      declare
         procedure F14;
         pragma Import (Ada, F14, "gtk__action__finalize_spec");
      begin
         F14;
      end;
      E394 := E394 - 1;
      declare
         procedure F15;
         pragma Import (Ada, F15, "gdk__device_manager__finalize_spec");
      begin
         F15;
      end;
      E304 := E304 - 1;
      ...
      declare
         procedure F16;
         pragma Import (Ada, F16, "gtk__print_operation__finalize_spec");
      begin
         F16;
      end;
      declare
         procedure F17;
         pragma Import (Ada, F17, "gtk__dialog__finalize_spec");
      begin
         F17;
      end;
      declare
         procedure F18;
         pragma Import (Ada, F18, "gtk__window__finalize_spec");
      begin
         F18;
      end;
      declare
      ...
      declare
         procedure F23;
         pragma Import (Ada, F23, "gtk__settings__finalize_spec");
      begin
         F23;
      end;
      declare
         procedure F24;
         pragma Import (Ada, F24, "gtk__status_bar__finalize_spec");
      begin
         F24;
      end;
      declare
         procedure F25;
         pragma Import (Ada, F25, "gtk__notebook__finalize_spec");
      begin
         F25;
      end;
      E346 := E346 - 1;
      declare
         procedure F26;
         pragma Import (Ada, F26, "gtk__misc__finalize_spec");
      begin
         F26;
      end;
      declare
         procedure F27;
         pragma Import (Ada, F27, "gtk__entry_completion__finalize_spec");
      begin
         F27;
      end;
      E294 := E294 - 1;
      declare
         procedure F28;
         pragma Import (Ada, F28, "gtk__box__finalize_spec");
      begin
         F28;
      end;
      E308 := E308 - 1;
      declare
         procedure F29;
         pragma Import (Ada, F29, "gtk__bin__finalize_spec");
      begin
         F29;
      end;
      declare
         procedure F30;
         pragma Import (Ada, F30, "gtk__container__finalize_spec");
      begin
         F30;
      end;
      declare
         procedure F31;
         pragma Import (Ada, F31, "gtk__cell_area__finalize_spec");
      begin
         F31;
      end;
      declare
         procedure F32;
         pragma Import (Ada, F32, "gtk__cell_renderer__finalize_spec");
      begin
         F32;
      end;
      declare
         procedure F33;
         pragma Import (Ada, F33, "gtk__widget__finalize_spec");
      begin
         F33;
      end;
      declare
         procedure F34;
         pragma Import (Ada, F34, "gtk__tree_model__finalize_spec");
      begin
         F34;
      end;
      declare
      ...
      declare
         procedure F36;
         pragma Import (Ada, F36, "gtk__selection_data__finalize_spec");
      begin
         F36;
      end;
      E340 := E340 - 1;
      declare
         procedure F37;
         pragma Import (Ada, F37, "gtk__icon_source__finalize_spec");
      begin
         F37;
      end;
      declare
         procedure F38;
         pragma Import (Ada, F38, "gtk__entry_buffer__finalize_spec");
      begin
         F38;
      end;
      declare
      ...
      declare
         procedure F40;
         pragma Import (Ada, F40, "gtk__accel_group__finalize_spec");
      begin
         F40;
      end;
      E249 := E249 - 1;
      declare
         procedure F41;
         pragma Import (Ada, F41, "gdk__drag_contexts__finalize_spec");
      begin
         F41;
      end;
      E247 := E247 - 1;
      declare
         procedure F42;
         pragma Import (Ada, F42, "gdk__device__finalize_spec");
      begin
         F42;
      end;
      E235 := E235 - 1;
      declare
         procedure F43;
         pragma Import (Ada, F43, "gdk__screen__finalize_spec");
      begin
         F43;
      end;
      E215 := E215 - 1;
      declare
         procedure F44;
         pragma Import (Ada, F44, "gdk__pixbuf__finalize_spec");
      begin
         F44;
      end;
      declare
         procedure F45;
         pragma Import (Ada, F45, "gdk__frame_clock__finalize_spec");
      begin
         F45;
      end;
      declare
         procedure F46;
         pragma Import (Ada, F46, "gdk__display__finalize_spec");
      begin
         F46;
      end;
      E358 := E358 - 1;
      ...
      declare
         procedure F60;
         pragma Import (Ada, F60, "gtk__target_list__finalize_spec");
      begin
         F60;
      end;
      E364 := E364 - 1;
      declare
         procedure F61;
         pragma Import (Ada, F61, "gtk__print_settings__finalize_spec");
      begin
         F61;
      end;
      E352 := E352 - 1;
      declare
         procedure F62;
         pragma Import (Ada, F62, "gtk__page_setup__finalize_spec");
      begin
         F62;
      end;
      E356 := E356 - 1;
      declare
         procedure F63;
         pragma Import (Ada, F63, "gtk__paper_size__finalize_spec");
      begin
         F63;
      end;
      E344 := E344 - 1;
      declare
         procedure F64;
         pragma Import (Ada, F64, "gtk__css_section__finalize_spec");
      begin
         F64;
      end;
      E328 := E328 - 1;
      declare
         procedure F65;
         pragma Import (Ada, F65, "gtk__cell_area_context__finalize_spec");
      begin
         F65;
      end;
      E257 := E257 - 1;
      declare
         procedure F66;
         pragma Import (Ada, F66, "gtk__builder__finalize_spec");
      begin
         F66;
      end;
      E314 := E314 - 1;
      declare
         procedure F67;
         pragma Import (Ada, F67, "glib__variant__finalize_spec");
      begin
         F67;
      end;
      E186 := E186 - 1;
      declare
         procedure F68;
         pragma Import (Ada, F68, "glib__object__finalize_spec");
      begin
         F68;
      end;
      E253 := E253 - 1;
      declare
         procedure F69;
         pragma Import (Ada, F69, "gdk__frame_timings__finalize_spec");
      begin
         F69;
      end;
      E165 := E165 - 1;
      declare
         procedure F70;
         pragma Import (Ada, F70, "glib__finalize_spec");
      begin
         F70;
      end;
      E456 := E456 - 1;
      declare
         procedure F71;
         pragma Import (Ada, F71, "system__tasking__protected_objects__entries__finalize_spec");
      begin
         F71;
      end;
      E176 := E176 - 1;
      ...
      declare
         procedure F73;
         pragma Import (Ada, F73, "ada__text_io__finalize_spec");
      begin
         F73;
      end;
      E190 := E190 - 1;
      ...
      declare
         procedure F75;
         pragma Import (Ada, F75, "system__finalization_masters__finalize_spec");
      begin
         F75;
      end;
      declare
...
--  BEGIN Object file/option list
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_buffergenerico.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_debug.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_tipos.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/double_buffer.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_graficos.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_cronometro_realtime.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_semaforo.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_coches.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_taxi.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_peaton.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/pkg_tren.o
   --   /home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/main.o
   --   -L/home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/
   --   -L/home/str/Escritorio/str-2021-murcia-gomez-francisco-joaquin/practica4/obj/
